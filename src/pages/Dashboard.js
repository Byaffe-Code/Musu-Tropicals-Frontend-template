                                            ...
                                            <div className="card border-0  bg-lightblue rounded-10">
                                                <div className="row">
                                                    <div className="col-lg-6 col-md-6 col-sm-6 p-5">
                                                        <h2 className="text-grey-900 fw-700 ls-0 font-xl lh-3 m-0">Musu Tropicals</h2>
                                                        ...
                                                        <a href="/dashboard" className="bg-current text-white rounded-25 btn-cart w-125 d-inline-block text-center font-xsssss p-3 fw-600 ls-6">ANALYTICS</a>
                                                    </div>
