                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 d-flex">
                            <Link to="/"><h1>Musu Tropicals</h1></Link>
                            <div className="header-search ms-auto me-2 d-flex">
                                <Button onClick={()=>{this.handleModel()}} className="location me-3 bg-transparent border-0">
                                    ...
                                    <h4 className="fw-600 font-xssss mt-0 text-green mb-0 ls-0">Kampala</h4>
                                </Button>
                                <Modal {...this.props} size="sm" aria-labelledby="contained-modal-title-vcenter" centered show={this.state.location}>
                                    ...
                                    <Modal.Body className="text-center pt-4">
                                        ...
                                        <div className="inner-addon left-addon">
                                            <input type="text" className="form-control ps-5 font-xssss border-sizelg rounded-6 bg-color-none fw-600 border text-grey-500" defaultValue="Muteesa II road, Ntinda" />
