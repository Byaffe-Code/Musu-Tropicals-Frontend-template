        ...
        return (
            ...
            {productList.map((value , index) => (
                ...
                <div key={index}  className={divClass}>
                    ...
                    <Link to="/single-product-4" className="d-block text-center" data-bs-toggle="modal" data-bs-target="#productmodal"><img src={`assets/images/${value.imageUrl}`} alt="banner" className="w-100 mt-3 mb-3 d-inline-block p-2 pt-0" /></Link>
                    ...
                    <div className="clearfix"></div>
                    <h2 className="mt-2"><Link to="/single-product-4" className="text-grey-700 fw-600 font-xsss lh-22 d-block ls-0">{value.title}</Link></h2>
